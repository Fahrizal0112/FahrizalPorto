    ...
    <div id="home">
      <section className="home">
        <div className="intro" data-aos="fade-up" data-aos-duration="1000">
          <div className="text">
            ...
            >
              Creative{" "}
              <span className="dynamic-text text-orange">{creativeText}</span>
            </h3>
            <div
      ...
      <section id="about" ref={aboutRef} className="about" data-aos="fade-up">
        ...
        <div className="about-content" data-aos="fade-up" data-aos-delay="200">
          <p className="text-xl">
            I am an experienced Software Engineer specializing in the
            development of websites and applications. With a primary focus on
            the <b className="text-orange">Node.js</b> and{" "}
            <b className="text-orange">JavaScript</b> frameworks, I am dedicated
            to bringing your digital projects to life efficiently and with high
            quality. Additionally, I possess strong skills in{" "}
            <b className="text-orange">Google Cloud Platform</b>, enabling me to{" "}
            <b className="text-orange">deploy</b> and manage your applications
            optimally. Combining technical expertise with practical experience,
            I am ready to help you achieve success in the digital world.
          </p>
          ...
          <div className="skills-grid">
            <div className="skill-card" data-aos="fade-up" data-aos-delay="100">
              ...
              <p className="text-white">
                Backend development with Express.js, RESTful APIs, and database
                integration
              </p>
            </div>
            ...
            <div className="skill-card" data-aos="fade-up" data-aos-delay="200">
              ...
              <h3>JavaScript</h3>
              <p className="text-white">
                Modern ES6+, async programming, and frontend frameworks
              </p>
            </div>
            ...
            <div className="skill-card" data-aos="fade-up" data-aos-delay="300">
              ...
              <h3>Google Cloud</h3>
              <p className="text-white">
                Cloud infrastructure, deployment, and scalable solutions
              </p>
            </div>
            ...
            <div className="skill-card" data-aos="fade-up" data-aos-delay="400">
              ...
              <h3>Docker</h3>
              <p className="text-white">
                Containerization, microservices architecture, and deployment
              </p>
            </div>
            ...
            <div className="skill-card" data-aos="fade-up" data-aos-delay="500">
              ...
              <h3>Kubernetes</h3>
              <p className="text-white">
                Container orchestration, scaling, and cluster management
              </p>
            </div>
            ...
            <div className="skill-card" data-aos="fade-up" data-aos-delay="600">
              ...
              <h3>CI/CD</h3>
              <p className="text-white">
                Automated testing, deployment pipelines, and continuous
                integration
              </p>
            </div>
          </div>
